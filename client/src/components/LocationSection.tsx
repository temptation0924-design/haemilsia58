 ...
 * Typography: Improved readability with consistent alignment and word-break
 */
    ...
    >
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <p
            className="text-[#8A7E72] text-[13px] sm:text-[14px] md:text-[15px] leading-[1.9] sm:leading-[2]"
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-5 sm:mb-6">
                ...
                <h3
                  className="font-serif text-[#4A3F35] text-lg sm:text-xl tracking-[0.05em]"
              ...
              <p
                className="text-[#4A3F35] text-[15px] sm:text-[16px] lg:text-[17px] leading-[1.9] mb-1.5"
                style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 400, wordBreak: "keep-all" }}
              >
                {ADDRESS}
              </p>
              <p
                className="text-[#9A8E82] text-[12px] sm:text-[13px] leading-[1.9] mb-6 sm:mb-7"
                style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300 }}
              >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 sm:flex-none flex items-center justify-center sm:justify-start gap-2 text-[11px] sm:text-[12px] tracking-[0.06em] sm:tracking-[0.08em] px-5 py-3 border border-[#E8E0D4] text-[#6B6058] hover:border-[#C8B89A] hover:text-[#4A3F35] active:border-[#C8B89A] active:text-[#4A3F35] transition-all duration-500"
                  style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300 }}
                >
                  {copied ? (
                    <>
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none flex items-center justify-center sm:justify-start gap-2 text-[11px] sm:text-[12px] tracking-[0.06em] sm:tracking-[0.08em] px-5 py-3 bg-[#4A3F35] text-[#FAF8F4]/90 hover:bg-[#5A4F45] active:bg-[#5A4F45] transition-all duration-500"
                  style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300 }}
                >
            ...
            >
              ...
              <div className="space-y-0">
                ...
                <div className="flex gap-4 sm:gap-5">
                  ...
                  <div className="pb-5 sm:pb-6">
                    <p
                      className="text-[#4A3F35] text-[13px] sm:text-[14px] mb-1.5"
                      style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 400 }}
                    >
                      강남역 출발
                    </p>
                    <p
                      className="text-[#9A8E82] text-[11px] sm:text-[12px] leading-[1.8]"
                      style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300 }}
                    >
                      경부고속도로 → 신갈JC 방면 진입
                    </p>
              ...
              <div className="mt-6 sm:mt-8 flex items-center gap-3 p-4 sm:p-5" style={{ backgroundColor: "#FAF8F4", border: "1px solid #E8E0D4" }}>
                ...
                <div>
                  ...
                  <p
                    className="text-[#9A8E82] text-[11px] sm:text-[12px] mt-1 leading-[1.7]"
                    style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300 }}
                  >
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6 sm:mb-8">
                ...
                <h3
                  className="font-serif text-[#FAF8F4]/90 text-lg sm:text-xl tracking-[0.05em]"
                  style={{ fontWeight: 400 }}
                >
                  주차 안내
                </h3>
              ...
              <div className="mb-6 sm:mb-8">
                ...
                <p
                  className="text-[#FAF8F4]/80 text-[14px] sm:text-[15px] lg:text-[16px] leading-[2] mb-3"
                  style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300 }}
                >
                  넉넉한 무료 전용 주차장 완비
                </p>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-3 p-3.5 sm:p-4" style={{ backgroundColor: "rgba(250, 248, 244, 0.06)", border: "1px solid rgba(200, 184, 154, 0.12)" }}>
                  ...
                  <p
                    className="text-[#FAF8F4]/65 text-[12px] sm:text-[13px] leading-[1.8]"
                    style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300, wordBreak: "keep-all" }}
                  >
              ...
              <div className="mt-6 sm:mt-8 pt-5 sm:pt-6" style={{ borderTop: "1px solid rgba(200, 184, 154, 0.15)" }}>
                <p
                  className="text-[#C8B89A]/80 text-[12px] sm:text-[13px] leading-[2] italic"
                  style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300, wordBreak: "keep-all" }}
                >
            ...
            >
              ...
              <a
                ...
                style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400, letterSpacing: "0.06em" }}
              >
                010-4819-9078
              </a>
              <p
                className="text-[#9A8E82] text-[11px] sm:text-[12px] mt-2 leading-[1.8]"
                style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300, wordBreak: "keep-all" }}
              >
            ...
            >
              <p
                className="text-[10px] sm:text-[11px] tracking-[0.2em] uppercase text-[#C8B89A] mb-3 sm:mb-4"
                style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 300 }}
              >
                Blog
              </p>
